...
console.log(myHouse.address?.city ? myHouse.address?.city : "City not available");
// Expected Output: "New York"

const noCityHouse: House = {};
console.log(noCityHouse.address?.city ? noCityHouse.address?.city : "City not available");
